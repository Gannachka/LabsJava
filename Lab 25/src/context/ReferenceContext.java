...
public class ReferenceContext{
    ...
    public List<ReferenceModel> getReferences(String filter) throws SQLException {
        ...
        if(filter!=null)
            statement= connection.prepareStatement("select * from WSREF where descriptions like ".concat("'%")+filter.concat("%'"));
        else
    ...
    public void addReferences(ReferenceModel referenceModel) throws SQLException {
        PreparedStatement statement = connection.prepareStatement("insert into WSREF(urln,descriptions,minus,plus) values(?,?,?,?)");
    ...
    public void updateReferences(ReferenceModel referenceModel) throws SQLException {
        PreparedStatement statement = connection.prepareStatement("update WSREF set descriptions=".concat("'")
